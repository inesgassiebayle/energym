...
const LessonAddition = () => {
    ...
    const handleSubmit = async (e) => {
            ...
            try {
                ...
                } else if (errorMsg.includes("Cannot create a class in a past date")) {
                    setDateError("Cannot schedule a class in the past");
                }
            }
        }
        ...
        return (
            <div className='create-activity-container'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    {roomError &&
                        <div className="error-message" style={{color: 'red', textAlign: 'center'}}>{roomError}</div>}
                    ...
                    <div className='form-actions'>
                        ...
                        <button type='button' onClick={() => navigate('/AdministratorHome/ManageSchedule')}>Cancel
                        </button>
                        {roomError && <div className="error-message"
                                           style={{color: 'red', textAlign: 'center'}}>{roomError}</div>}
                        {professorError && <div className="error-message"
                                                style={{color: 'red', textAlign: 'center'}}>{professorError}</div>}
                        {activityError && <div className="error-message"
                                               style={{color: 'red', textAlign: 'center'}}>{activityError}</div>}
                        {dateError && <div className="error-message"
                                           style={{color: 'red', textAlign: 'center'}}>{dateError}</div>}
